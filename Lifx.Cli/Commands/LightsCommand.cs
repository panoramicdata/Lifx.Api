...
var request = LightsHandler.BuildOnRequest(duration);
...
var request = LightsHandler.BuildOffRequest(duration);
await client.Lights.SetStateAsync(SelectorParser.ParseSelector(selector), request, cancellationToken);
...
var request = LightsHandler.BuildToggleRequest(duration);
...
var request = LightsHandler.BuildColorRequest(color, duration);
await client.Lights.SetStateAsync(SelectorParser.ParseSelector(selector), request, cancellationToken);
...
try
{
var request = LightsHandler.BuildBrightnessRequest(brightness, duration);
